...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String,Object>> handleEmailALreadyExits(EmailAlreadyExistException ex){
        log.warn("BadCredentialsException : {}",ex.getMessage(),ex);
        return buildResponse(HttpStatus.FORBIDDEN, ex.getMessage());
    }
    ...
    public void handleCLientAbort(Exception exception){
        log.debug("Client closed connection during streaming(excepted foor video seeking.buffering");
    }
